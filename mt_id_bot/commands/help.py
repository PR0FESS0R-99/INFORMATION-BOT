...
from mt_id_bot.text.cmd_text import HELP_MSG
from mt_id_bot.button.cmd_button import HELP_BUTTON
from mt_id_bot.running.run import RUN_H
from mt_id_bot.text.fsub_text import SUB_TEXT, SUB_JOIN, SUB_TRY, SUB_UPDATE

# start and Update channel added
@Client.on_message(filters.private & filters.command(f"{RUN_H}"))
